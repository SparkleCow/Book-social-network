...
export class FeedbackService extends BaseService {
  ...
  static readonly GetAllFeedbacksByBookPath = '/feedback/book/{book-id}';
   ...
   */
  getAllFeedbacksByBook$Response(params: GetAllFeedbacksByBook$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseFeedbackResponseDto>> {
   ...
   * This method doesn't expect any request body.
   */
  getAllFeedbacksByBook(params: GetAllFeedbacksByBook$Params, context?: HttpContext): Observable<PageResponseFeedbackResponseDto> {
